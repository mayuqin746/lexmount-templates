...
```bash
git clone --depth 1 https://github.com/mayuqin746/lexmount-templates.git
cd lexmount-templates/templates/open-page-and-verify/typescript
npm install
npm start
```
...
```bash
git clone --depth 1 https://github.com/mayuqin746/lexmount-templates.git
cd lexmount-templates/templates/open-page-and-verify/python
python run.py
```
